(function () {
    var canvastag = document.getElementById("donut");
        ...
        var canvasframe = function () {
            ...
            for (var j = 0; j < 6.28; j += 0.3) {
                ...
                for (i = 0; i < 6.28; i += 0.1) {
                    ...
                    var xp = 300 + K1 * ooz * x * 2; // x' = screen space coordinate, translated and scaled to fit our 320x240 canvas element
                    var yp = 240 - K1 * ooz * y * 2; // y' (it's negative here because in our output, positive y goes down but in our 3D space, positive y goes up)
    ...
    const scrollListener = function () {
        A = 0.07 * window.scrollY / 50;
        B = 0.03 * window.scrollY / 50;
    }
